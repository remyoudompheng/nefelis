...
PARAMS = [
    ...
    (120, 3, 5000, 5000, 13, 13, 10, 10, 23, 300),
    (140, 3, 20000, 10000, 15, 14, 10, 10, 23, 500),
    (160, 3, 30000, 20000, 16, 15, 10, 10, 23, 1000),
    (180, 3, 50000, 50000, 17, 17, 10, 10, 24, 800),
    # 1 large prime
    (200, 3, 80000, 80000, 18, 18, 19, 19, 25, 1000),
    ...
    (220, 4, 200_000, 100_000, 20, 18, 20, 19, 25, 2000),
    (240, 4, 300_000, 150_000, 20, 19, 21, 20, 25, 5000),
    (260, 4, 500_000, 250_000, 21, 20, 22, 21, 26, 5000),  # 1 large prime + 2 bits
    (280, 4, 800_000, 400_000, 22, 21, 23, 22, 26, 10000),
    ...
    (440, 4, 10000_000, 8000_000, 29, 28, 57, 31, 29, 300000),
...
PARAMS_SNFS = [
    # bitsize, degree, B1f, B2f, B2g, cofactor bits, cofactor2 bits, A=logarea, qmin
    (100, 3, 1_000, 1_000, 13, 12, 12, 11, 23, 20),
    (125, 3, 2_000, 2_000, 14, 14, 13, 13, 24, 50),
    (150, 3, 5_000, 5_000, 15, 15, 15, 15, 24, 100),
    (175, 3, 15_000, 10_000, 17, 16, 16, 16, 24, 200),
    (200, 3, 20_000, 20_000, 17, 17, 17, 17, 25, 100),
    (225, 3, 60_000, 40_000, 18, 17, 18, 17, 25, 200),
    (250, 3, 100_000, 80_000, 19, 18, 18, 18, 26, 400),
    (275, 4, 150_000, 100_000, 19, 18, 19, 18, 26, 800),
    (300, 4, 200_000, 100_000, 19, 19, 19, 19, 26, 1000),
    (325, 4, 300_000, 150_000, 20, 20, 20, 20, 26, 2000),
    (350, 4, 400_000, 200_000, 21, 20, 22, 21, 27, 2000),
    (375, 4, 600_000, 500_000, 22, 21, 23, 22, 27, 3000),
    (400, 4, 1000_000, 600_000, 23, 22, 25, 24, 27, 5000),
    (450, 5, 2500_000, 1500_000, 24, 23, 26, 25, 28, 10000),
    (500, 5, 4000_000, 3000_000, 27, 26, 30, 29, 28, 20000),
    # 2 large primes
