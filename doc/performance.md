...
| Task          |   Number    | Ryzen 7840HS (Cado-NFS) | Radeon 780M iGPU (79fd8c16) | RTX 3080 Ti (1340b4eb) |
| ------------- | ----------- | ----------------------- | --------------------------- | ---------------------- |
| factor (GNFS) | 10^90+187   | 133s |   90s | 140s |
| factor (GNFS) | RSA-110     | 965s | 1183s | 895s |
| factor (GNFS) | RSA-130     |187min|337min |270min|
| factor (GNFS) | RSA-150     | | |
| factor (SNFS) | 2^401-1     | 155s |   72s | 120s |
| factor (SNFS) | 2^499-1     | 970s |  802s | 800s |
| factor (SNFS) | 2^599-1     |183min|213min |120min|
| dlog (JL deg3)| 10^75+21259 |      |  24s  |  35s |
| dlog (JL deg3)| 10^90+36307 |      | 164s  | 155s |
| dlog (JL deg3)| 10^105+70399|      | 38min | 22min|
| dlog (JL deg3)|10^120+138139|      | 350min|174min|
